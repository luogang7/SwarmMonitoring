...
sudo wget https://github.com/luogang7/SwarmMonitoring/blob/main/docker/docker-compose.yaml
sudo mkdir /root/swarmon/ && sudo mkdir /root/swarmon/mysql && sudo mkdir /root/swarmon/mysql/init
sudo wget https://github.com/luogang7/SwarmMonitoring/blob/main/docker/mysql/createdb.sql -P /root/swarmon/mysql/init
sudo mkdir /root/swarmon/grafana
sudo wget https://github.com/luogang7/SwarmMonitoring/blob/main/docker/grafana/grafana.tar.gz
